...
int main()
{
  ...
  39:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      buf[i] = i;
  40:	89 04 82             	mov    %eax,(%edx,%eax,4)
   for(int i=0; i<14; i++){
  43:	83 c0 01             	add    $0x1,%eax
  46:	83 f8 0e             	cmp    $0xe,%eax
  49:	75 f5                	jne    40 <main+0x40>
   }
  ...
  50:	52                   	push   %edx
  51:	53                   	push   %ebx
  52:	e8 8b 02 00 00       	call   2e2 <write>
   close(fd2);
  57:	89 1c 24             	mov    %ebx,(%esp)
  5a:	e8 8b 02 00 00       	call   2ea <close>
   exit();
 ...
 379:	85 d2                	test   %edx,%edx
{
 ...
 3a7:	f7 f1                	div    %ecx
 3a9:	0f b6 92 7c 07 00 00 	movzbl 0x77c(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 5c4:	e9 8f fe ff ff       	jmp    458 <printf+0x48>
          s = "(null)";
 5c9:	bb 72 07 00 00       	mov    $0x772,%ebx
        while(*s != 0){
