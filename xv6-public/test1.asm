...
int main()
{
  ...
  12:	68 00 04 00 00       	push   $0x400
  17:	68 88 07 00 00       	push   $0x788
  1c:	e8 01 03 00 00       	call   322 <open>
   fd1 = open("text1.txt", O_RDWR);//open the file as read and write mode
  21:	58                   	pop    %eax
  22:	5a                   	pop    %edx
  23:	6a 02                	push   $0x2
  25:	68 88 07 00 00       	push   $0x788
  2a:	e8 f3 02 00 00       	call   322 <open>
  ...
  32:	89 c3                	mov    %eax,%ebx
   write(fd1, "aaaaaaa", 7);// write data to the small file
  34:	6a 07                	push   $0x7
  36:	68 92 07 00 00       	push   $0x792
  3b:	50                   	push   %eax
  3c:	e8 c1 02 00 00       	call   302 <write>
   close(fd1);// when finish write, close the file
  41:	89 1c 24             	mov    %ebx,(%esp)
  44:	e8 c1 02 00 00       	call   30a <close>
   char c;
  ...
  52:	e8 cb 02 00 00       	call   322 <open>
  57:	89 c3                	mov    %eax,%ebx
   read(fd1,&c,1);// read data from the small file
  59:	8d 45 f7             	lea    -0x9(%ebp),%eax
  5c:	83 c4 0c             	add    $0xc,%esp
  5f:	6a 01                	push   $0x1
  61:	50                   	push   %eax
  62:	53                   	push   %ebx
  63:	e8 92 02 00 00       	call   2fa <read>
   printf(1, "%c\n", c);// print the data we read
  68:	0f be 45 f7          	movsbl -0x9(%ebp),%eax
  6c:	83 c4 0c             	add    $0xc,%esp
  6f:	50                   	push   %eax
  70:	68 9a 07 00 00       	push   $0x79a
  75:	6a 01                	push   $0x1
  77:	e8 b4 03 00 00       	call   430 <printf>
   close(fd1);
  7c:	89 1c 24             	mov    %ebx,(%esp)
  7f:	e8 86 02 00 00       	call   30a <close>
   exit();
...
printf(int fd, const char *fmt, ...)
{
 ...
 5e4:	e9 8f fe ff ff       	jmp    478 <printf+0x48>
          s = "(null)";
 5e9:	bb 9e 07 00 00       	mov    $0x79e,%ebx
        while(*s != 0){
